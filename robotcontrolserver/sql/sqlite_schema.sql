...
CREATE TABLE IF NOT EXISTS ROBOTTASK (
    ...
    DESCRIPTION TEXT,
    ROBOTTYPEID INTEGER,
    ROBOTTASKTEMPLATEID INTEGER,
    DELIVERYFROMPOINTID INTEGER,
    DELIVERYTOPOINTID INTEGER,
    CAPACITY INTEGER,
    CREATEAT DATETIME,
    FOREIGN KEY (ROBOTTYPEID) REFERENCES ROBOTTYPE(ID) ON DELETE SET NULL,
    FOREIGN KEY (ROBOTTASKTEMPLATEID) REFERENCES ROBOTTASKTEMPLATE(ID) ON DELETE SET NULL,
...
CREATE INDEX IF NOT EXISTS IX_ROBOTTASK_ROBOTTASKTEMPLATEID ON ROBOTTASK(ROBOTTASKTEMPLATEID);
